...
public class AssignmentServiceImplementation implements AssignmentService {
  ...
  public Optional<Assignment> addAssignment(Long id, Long studentID, Long labProblemID, int grade)
    ...
    log.trace(
        "addLabProblem - method entered: id={}, studentID={}, labProblemID={}. grade={}",
        id,
        studentID,
        labProblemID,
        grade);
    ...
    Optional<Assignment> checkForPresence = repository.findById(id);

    checkForPresence.ifPresentOrElse(assignmentEmpty -> {}, () -> repository.save(newAssignment));
  ...
  public void updateAssignment(Long id, Long studentID, Long labProblemID, int grade)
      throws ValidatorException {
    log.trace(
        "updateAssignment - method entered: studentId {}, labProblemID {}, grade{}",
        studentID,
        labProblemID,
        grade);
