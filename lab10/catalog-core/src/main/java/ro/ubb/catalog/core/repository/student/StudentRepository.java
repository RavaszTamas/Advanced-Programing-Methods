...
/** Created by radu. */
@Component("studentCustomRepositoryJpql")
public interface StudentRepository
    extends Repository<Student, Long>, JpaSpecificationExecutor<Student>, StudentCustomRepository {

  List<Student> findByGroupNumber(int groupNumber);

  @Query("select distinct s from Student  s")
  @EntityGraph(
      value = "studentWithAssignmentsWithLabProblems",
